        ...
        <div className="min-h-screen bg-bg-page text-text-primary pb-20">
            ...
            <div className="max-w-5xl mx-auto px-6 md:px-10 py-12">
                ...
                {!loading && items.length === 0 && (
                    <div className="bg-bg-card border border-border-color p-8 rounded text-text-secondary text-sm" data-testid="no-checklists">
                ...
                <div className="space-y-8">
                    {items.map((cl) => {
                        ...
                        return (
                            <div key={cl.id} className="bg-bg-card border border-border-color p-8 rounded-lg" data-testid={`checklist-${cl.id}`}>
                                ...
                                <ul className="divide-y divide-zinc-900 border border-border-color rounded bg-bg-card/40">
                                    {cl.steps.map((s, i) => (
                                        <li key={i} className="flex items-start gap-3.5 p-4 hover:bg-bg-card/70 transition-all">
                                            <Checkbox
